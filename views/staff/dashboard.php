    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
         <div class="bg-white p-8 rounded-[2.5rem] shadow-sm border border-slate-100">
            ...
            <div class="space-y-6">
                <div class="relative pl-6 border-l-2 border-blue-500">
                    ...
                    <p class="text-[15px] font-black text-blue-600 uppercase tracking-tighter">ប្រជុំបុគ្គលិក</p>
                    <p class="text-[17px] font-bold text-slate-700 mt-1">ថ្ងៃសុក្រ ម៉ោង ៤ រសៀល នៅបន្ទប់ប្រជុំធំ</p>
                    <p class="text-[13px] text-slate-500 mt-1">បង្ហោះមុននេះ ២ ម៉ោង</p>
                </div>
                ...
                <div class="relative pl-6 border-l-2 border-slate-200">
                    ...
                    <p class="text-[15px] font-black text-slate-400 uppercase tracking-tighter">ឈប់សម្រាក</p>
                    <p class="text-[17px] font-bold text-slate-700 mt-1">ថ្ងៃបុណ្យឯករាជ្យជាតិ ឈប់សម្រាក ១ ថ្ងៃ</p>
                    <p class="text-[13px] text-slate-400 mt-1">ម្សិលមិញ</p>
                </div>
            </div>

            <a href="announcements.php" class="mt-10 block w-full py-4 bg-blue-600 text-white rounded-2xl text-center font-bold text-[17px] hover:bg-blue-500 transition ">
        ...
        <div class="lg:col-span-2 bg-white p-8 rounded-[2.5rem] shadow-sm border border-slate-100">
            <div class="flex items-center justify-between mb-8">
                ...
                <button class="bg-blue-600 text-white text-[15px] font-bold hover: py-3 px-6 items-center  rounded-2xl cursor-pointer">បន្ថែមការងារ</button>
            </div>
            ...
            <div class="space-y-4">
                <div class="flex items-center p-4 bg-slate-50 rounded-2xl border border-slate-100 group hover:bg-white hover:shadow-md transition-all">
                    ...
                    <div class="flex-1">
                        <p class="text-[15px] font-bold text-slate-700">ពិនិត្យវត្តមានសិស្សថ្នាក់ទី ១២ វិទ្យាសាស្ត្រ</p>
                        <p class="text-[13px] text-slate-500 uppercase mt-1">ថ្ងៃនេះ ម៉ោង ៩:០០ ព្រឹក</p>
                    </div>
                ...
                <div class="flex items-center p-4 bg-slate-50 rounded-2xl border border-slate-100 group hover:bg-white hover:shadow-md transition-all">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-[13px] text-slate-400 uppercase mt-1">ថ្ងៃស្អែក</p>
                    </div>
                </div>
