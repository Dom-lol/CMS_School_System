    ...
    <div class="max-w-2xl mx-auto bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
        ...
        <form action="../../actions/announcements/update.php" method="POST" class="space-y-4">
            ...
            <div class="flex gap-3 pt-4">
                <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded-xl font-bold hover:bg-blue-700 transition shadow-lg shadow-blue-200">រក្សាទុកការកែប្រែ</button>
                <a href="announcements.php" class="bg-slate-100 text-slate-600 px-6 py-2 rounded-xl font-bold hover:bg-slate-200 transition">ត្រឡប់ក្រោយ</a>
            </div>
        </form>
    </div>
</main>
