...
// កំណត់ការបង្ហាញឈ្មោះ (ប្រើឈ្មោះខ្មែរពី DB ជាអាទិភាព)
        ...
        <main class="flex-1 overflow-y-auto p-6 md:p-10">
            <div class="max-w-7xl mx-auto">
                ...
                <div class="mb-10">
                    ...
                    <p class="text-slate-500 mt-2 text-lg italic">សូមស្វាគមន៍មកកាន់វិទ្យាល័យលំដាប់ពិភពលោក</p>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div class="lg:col-span-2 bg-white rounded-[2.5rem] shadow-sm border border-slate-100 p-8 md:p-10">
                        <div class="flex items-center gap-4 mb-8 border-b border-slate-50 pb-6">
                            ...
                            <h2 class="text-xl font-bold text-slate-800">ព័ត៌មានលម្អិតផ្ទាល់ខ្លួន</h2>
                        </div>
                        
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                            <div class="flex flex-col gap-1 p-4 bg-slate-50 rounded-2xl border border-slate-100 hover:bg-white hover:shadow-md transition-all">
                            ...
                            <div class="flex flex-col gap-1 p-4 bg-slate-50 rounded-2xl border border-slate-100 hover:bg-white hover:shadow-md transition-all">
                                <span class="text-slate-400 text-xs font-bold uppercase">ទីកន្លែងកំណើត (POB)</span>
                                <span class="text-slate-800 font-bold text-sm leading-relaxed"><?php echo $student_info['pob'] ?? 'មិនមានទិន្នន័យ'; ?></span>
                            </div>
                            <div class="md:col-span-2 flex flex-col gap-1 p-4 bg-blue-50/30 rounded-2xl border border-blue-100 hover:bg-white hover:shadow-md transition-all">
                                <span class="text-blue-400 text-xs font-bold uppercase">អាសយដ្ឋានបច្ចុប្បន្ន</span>
                                <span class="text-slate-800 font-bold text-sm leading-relaxed"><?php echo $student_info['address'] ?? 'មិនមានទិន្នន័យ'; ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-[2.5rem] shadow-sm border border-slate-100 p-8 flex flex-col justify-between">
                        <div>
                            ...
                            <h3 class="text-lg font-bold text-slate-800">កាលវិភាគសិក្សា</h3>
                            <p class="text-slate-400 text-sm mt-1 italic">ពិនិត្យម៉ោងសិក្សាថ្ងៃនេះ</p>
                        </div>
                        <div class="mt-8 flex items-baseline gap-2">
                            <span class="text-6xl font-black text-slate-900 leading-none">?</span>
