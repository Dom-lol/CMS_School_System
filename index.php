    ...
    <div class="flex flex-1 items-center justify-center px-4 py-10">   
        <div class="bg-white p-8 md:p-10 rounded-2xl shadow-2xl w-full max-w-md">
            ...
            <form action="actions/auth/login_user.php" method="POST" class="space-y-5">
                <div>
                    <label class="block text-[14px] font-medium text-gray-800 mb-1">តួនាទី</label>
                    <select name="role" class="text-[20px] w-full border border-slate-200 p-3 rounded-xl outline-none focus:ring-2 focus:ring-blue-500 bg-slate-50 transition-all">
                ...
                <div>
                    <label class="block text-[14px] font-medium text-gray-800 mb-1">ឈ្មោះអ្នកប្រើប្រាស់</label>
                ...
                <div>
                    <label class="block text-[14px] font-medium text-gray-800 mb-1">លេខសម្ងាត់</label>
